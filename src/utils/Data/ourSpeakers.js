  ...
  },
  {
    ...
    speakers: [
      ...
      },
      {
        id: 2,
        name: 'Vidi Aldiano',
        description: 'Oxavia Aldiano, also known as Vidi, is a podcaster and part-time singer in Indonesia. Vidi began his music career in 2008 with the release of the album “Pelangi di Malam Hari”. The songs "Nuansa Bening" and "Status Palsu" from the album were popular and brought him widespread public recognition.'
      },
      {
        id: 3,
        name: 'Baskara Putra',
        description: 'Daniel Baskara Putra, also known Monomim Hindia, is an Indonesian singer-songwriter, record producer, and composer. Baskara is the vocalist of the music group Feast and the frontman of the band he formed in 2019, called Lomba Sihir. He began his music career in 2012 when he, along with his friends, founded the music group Feast. Later, in 2018, Baskara decided to transition to a solo career under the name Hindia, releasing the song "No One Will Find Me" from the compilation album “Bertamu”.'
      }
    ],
  },
]
