    ...
    <section className='container py-5'>
      <div className='row d-flex align-items-center'>
        <div className="col">
          ...
          <a target='_blank' rel="noreferrer" href='https://www.eventbrite.com/e/indonesia-youth-sustainability-forum-2024-tickets-970233523587?aff=oddtdtcreator' className='btn btn-success'>REGISTER NOW</a>
        </div>
        <div className="col">
          <p>
